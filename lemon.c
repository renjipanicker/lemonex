...
static int s_lxclasslist[] =
{
  ...
  0x0904, 0x0939, /* DEVANAGARI LETTER SHORT A */
  0x093D, 0x093D, /* DEVANAGARI SIGN AVAGRAHA */
  0x0950, 0x0950, /* DEVANAGARI OM */
  0x0958, 0x0961, /* DEVANAGARI LETTER QA */
  0x0972, 0x0980, /* DEVANAGARI LETTER CANDRA A */
  0x0985, 0x09B9, /* BENGALI LETTER A */
  0x09BD, 0x09BD, /* BENGALI SIGN AVAGRAHA */
  0x09CE, 0x09CE, /* BENGALI LETTER KHANDA TA */
  0x09DC, 0x09E1, /* BENGALI LETTER RRA */
  0x09F0, 0x09F1, /* BENGALI LETTER RA WITH MIDDLE DIAGONAL */
  0x0A05, 0x0A39, /* GURMUKHI LETTER A */
  0x0A59, 0x0A5E, /* GURMUKHI LETTER KHHA */
  0x0A72, 0x0A74, /* GURMUKHI IRI */
  0x0A85, 0x0AB9, /* GUJARATI LETTER A */
  0x0ABD, 0x0ABD, /* GUJARATI SIGN AVAGRAHA */
  0x0AD0, 0x0AE1, /* GUJARATI OM */
  0x0AF9, 0x0AF9, /* GUJARATI LETTER ZHA */
  0x0B05, 0x0B39, /* ORIYA LETTER A */
  0x0B3D, 0x0B3D, /* ORIYA SIGN AVAGRAHA */
  0x0B5C, 0x0B61, /* ORIYA LETTER RRA */
  0x0B71, 0x0B71, /* ORIYA LETTER WA */
  0x0B83, 0x0BB9, /* TAMIL SIGN VISARGA */
  0x0BD0, 0x0BD0, /* TAMIL OM */
  0x0C05, 0x0C3D, /* TELUGU LETTER A */
  0x0C58, 0x0C61, /* TELUGU LETTER TSA */
  0x0C85, 0x0CB9, /* KANNADA LETTER A */
  0x0CBD, 0x0CBD, /* KANNADA SIGN AVAGRAHA */
  0x0CDE, 0x0CE1, /* KANNADA LETTER FA */
  0x0CF1, 0x0CF2, /* KANNADA SIGN JIHVAMULIYA */
  0x0D05, 0x0D3D, /* MALAYALAM LETTER A */
  0x0D4E, 0x0D4E, /* MALAYALAM LETTER DOT REPH */
  0x0D5F, 0x0D61, /* MALAYALAM LETTER ARCHAIC II */
  0x0D7A, 0x0D7F, /* MALAYALAM LETTER CHILLU NN */
...
PRIVATE char *file_makename(struct lemon *lemp, const char *suffix)
{
  ...
  if(cp == 0)
      cp = lemp->filename;
  name = malloc( lemonStrlen(ofiledir) + lemonStrlen(cp) + lemonStrlen(suffix) + 5 );
  if( name==0 ){
...
#endif
      fprintf(out, "LX_SEND(%d);return -1;", lemp->errsym->index);
    }
  }
  if(tx_type == REGULAR_TX){
    fprintf(out, "\n");(*lineno)++;
    ...
    for(struct LxTransition* tx = curr_state->head_transition; tx != 0; tx = tx->next_transition){
      ...
      if((tx->ch0 == 0) && (tx->ch1 == 0)){
        ...
        if(tx->tx_type == NOT_TX){
          ...
          fprintf(out, "LX_ADVANCE(%d);goto S%d; ", tx->next_state->state_id, tx->next_state->state_id);
        }
        fprintf(out, "}");
        fprintf(out, "\n");(*lineno)++;
      }
...
#ifdef LEMONEX
  fprintf(out,"#define LEMONEX 1\n"); lineno++;
  fprintf(out,"#define LEMONEX_DBG %d\n", LEMONEX_DBG); lineno++;
#endif
